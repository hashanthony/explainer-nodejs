var data = {
    "cells": [
        ...
        { id: 46, "template": "template/1", "size": { height: 2, width: 3 } },
        { id: 47, "template": "template/2", "size": { height: 2, width: 3 } },
        { id: 48, "template": "template/3", "size": { height: 2, width: 3 } },
        { id: 49, "template": "template/4", "size": { height: 2, width: 3 } }
    ]
};
